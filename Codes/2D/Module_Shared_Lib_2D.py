...
path = os.getcwd()
myclib = CDLL(os.path.join(path, "LBM_2D.so"))
...
myclib.macroField.argtypes = [P3D, P2D, P2D, c_int, c_int, c_int, c_int]
myclib.macroField.restype  = None

'''initilization of macroscopic fields (FUNCTION PROTOTYPE)'''
myclib.initializeField.argtypes = [P2D, P2D, P2D, P2D, P2D, P2D, c_int, c_int, c_int]
myclib.initializeField.restype  = None

'''collision and streaming (FUNCTION PROTOTYPE)'''
myclib.collNotForcingNode.argtypes = [P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P2D, P2D, P2D, P2D, P2D, P2D, P2D, P2D, c_int, c_int, c_int, c_int]
myclib.collNotForcingNode.restype  = None


myclib.collForcingNode.argtypes = [P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P2D, P2D, P2D, P2D, P2D, P2D, P2D, P2D, c_int, c_int, c_int, c_int, c_int, c_int, c_int]
myclib.collForcingNode.restype  = None

myclib.streaming.argtypes = [P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, P3D, c_int, c_int, c_int, c_int]
