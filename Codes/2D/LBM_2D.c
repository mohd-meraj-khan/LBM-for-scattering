...
void macroField(float* dis_func, float* mat_prop, float* field, int y, int x, int q, int N) {
...
void initializeField(float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, int y, int x, int N) {
...
void collForcingNode(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, float* er, float* mur, int y, int x, int q, int xloc, int ymin, int ymax, int N) {
...
void collNotForcingNode(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, float* er, float* mur, int y, int x, int q, int N) {
...
void streaming(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, int y, int x, int q, int N) {
