...
with writer.saving(fig, Video_Name,300):
    for t in range(int(Time)):
        ...
        myclib.macroField(f, Ex, Ey, Ez, Hx, Hy, Hz, Px, Py, Pz, Mx, My, Mz, er, mur, Ny, Nx, Q)
        ...
        if (t >= 0):
            ...
            myclib.collForcingNode(f, fb, Ex, Ey, Ez, Hx, Hy, Hz, Px, Py, Pz, Mx, My, Mz, Pxb, Pyb, Pzb, Mxb, Myb, Mzb, er, mur, Ny, Nx, Q, xloc, ymin, ymax)
            myclib.streaming(f, fb, Px, Py, Pz, Mx, My, Mz, Pxb, Pyb, Pzb, Mxb, Myb, Mzb, Ny, Nx, Q)
            

        else:
            
            # collision and streaming (the 2 steps of LBM) when field is not forced
            myclib.collNotForcingNode(f, fb, Ex, Ey, Ez, Hx, Hy, Hz, Px, Py, Pz, Mx, My, Mz, Pxb, Pyb, Pzb, Mxb, Myb, Mzb, er, mur, Ny, Nx, Q)
            myclib.streaming(f, fb, Px, Py, Pz, Mx, My, Mz, Pxb, Pyb, Pzb, Mxb, Myb, Mzb, Ny, Nx, Q)
