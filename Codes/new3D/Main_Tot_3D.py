...
fz = open(force+"/Fz_er_{}.txt".format(er2), "a")
np.savetxt(fz, Fz_avg)
fz.close()


tx = open(force+"/Tx_er_{}.txt".format(er2), "a")
np.savetxt(tx, Tx_avg)
tx.close()

ty = open(force+"/Ty_er_{}.txt".format(er2), "a")
np.savetxt(ty, Ty_avg)
ty.close()

tz = open(force+"/Tz_er_{}.txt".format(er2), "a")
np.savetxt(tz, Tz_avg)
tz.close()
...
np.save(MA+"/FzIns_{}_{}.npy".format(er2, ratio), FzIns)

np.save(MA+"/TxIns_{}_{}.npy".format(er2, ratio), TxIns)
np.save(MA+"/TyIns_{}_{}.npy".format(er2, ratio), TyIns)
