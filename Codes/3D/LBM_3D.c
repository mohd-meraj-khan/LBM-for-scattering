...
void macroField(float* dis_func, float* mat_prop, float* field, int z, int y, int x, int q, int N) {
...
void initializeField(float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, int z, int y, int x, int N) {
...
void collForcingNode(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, float* er, float* mur, int z, int y, int x, int q, int xloc, int ymin, int ymax, int zmin, int zmax, int N) {
	...
	for (i = 0; i < z; i++) {
		for (j = 0; j < y; j++) {
			for (k = 0; k < x; k++) {
				...
				if (j >= ymin && j < ymax && k == xloc && i >= zmin && i <= zmax) { // no collision at the forcing node
...
void collNotForcingNode(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, float* Ex, float* Ey, float* Ez, float* Hx, float* Hy, float* Hz, float* er, float* mur, int z, int y, int x, int q, int N) {
...
void streaming(float* ex, float* ey, float* ez, float* hx, float* hy, float* hz, float* exb, float* eyb, float* ezb, float* hxb, float* hyb, float* hzb, int z, int y, int x, int q, int N) {
	...
	for (i = 0; i < z; i++) {
		for (j = 0; j < y; j++) {
			for (k = 0; k < x; k++) {
				...
				ex[i*y*x*q + j*x*q + k*q + 5] = exb[i5*y*x*q + j*x*q + k*q + 5];
				ex[i*y*x*q + j*x*q + k*q + 6] = exb[i6*y*x*q + j*x*q + k*q + 6];
				...
				ey[i*y*x*q + j*x*q + k*q + 5] = eyb[i5*y*x*q + j*x*q + k*q + 5];
				ey[i*y*x*q + j*x*q + k*q + 6] = eyb[i6*y*x*q + j*x*q + k*q + 6];
				...
				ez[i*y*x*q + j*x*q + k*q + 5] = ezb[i5*y*x*q + j*x*q + k*q + 5];
				ez[i*y*x*q + j*x*q + k*q + 6] = ezb[i6*y*x*q + j*x*q + k*q + 6];
				...
				hx[i*y*x*q + j*x*q + k*q + 5] = hxb[i5*y*x*q + j*x*q + k*q + 5];
				hx[i*y*x*q + j*x*q + k*q + 6] = hxb[i6*y*x*q + j*x*q + k*q + 6];
				...
				hy[i*y*x*q + j*x*q + k*q + 5] = hyb[i5*y*x*q + j*x*q + k*q + 5];
				hy[i*y*x*q + j*x*q + k*q + 6] = hyb[i6*y*x*q + j*x*q + k*q + 6];
				...
				hz[i*y*x*q + j*x*q + k*q + 5] = hzb[i5*y*x*q + j*x*q + k*q + 5];
				hz[i*y*x*q + j*x*q + k*q + 6] = hzb[i6*y*x*q + j*x*q + k*q + 6];
