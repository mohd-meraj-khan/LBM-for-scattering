...
er1, mur1, er2 = 1, 1, 20   # material properties i.e. permittivity and permeabilty
...
EzScat2 = open(directory+"/Ez_scat2_{}.txt".format(er2), "w")
np.savetxt(EzScat2, Ez_scat_interp2, fmt='%.4e')
EzScat2.close()

EzScat3 = open(directory+"/Ez_scat3_{}.txt".format(er2), "w")
np.savetxt(EzScat3, Ez_scat_interp3, fmt='%.4e')
EzScat3.close()

EzScat4 = open(directory+"/Ez_scat4_{}.txt".format(er2), "w")
np.savetxt(EzScat4, Ez_scat_interp4, fmt='%.4e')
EzScat4.close()

EzScat5 = open(directory+"/Ez_scat5_{}.txt".format(er2), "w")
