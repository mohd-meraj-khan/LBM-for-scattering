...
ax1 = ax.inset_axes([0.57, 0.78, 0.4, 0.2])

plt.plot(phi, BRCS_exact[0], 'b-')
plt.plot(phi, BRCS_exact[1], 'c-')
plt.plot(phi, BRCS_LBM[0], 'b--')
plt.plot(phi, BRCS_LBM[1], 'c--')


ax1.plot(R, MRCS_exact[0], 'b-')
ax1.plot(R, MRCS_exact[1], 'c-')
ax1.plot(RLBM, MRCS_LBM[0], 'bo')
ax1.plot(RLBM, MRCS_LBM[1], 'co')
...
plt.savefig('RCS_GO_er_{}.svg'.format(er2))
plt.close()
################################################################################
