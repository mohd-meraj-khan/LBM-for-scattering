...
ratio = float(parameters[1])  # ratio = a / wavelength
...
for t in range(int(Time)):
    ...
    if (t%100 == 0):
        t2 = time.time()
        remaining_time = (t2 - t1) * (Time - t) / 60
##        print(f"Approximate time left in minutes: {remaining_time:.2f}", end="\r")
...
##fxAvg1 = open(directory+"/FxAvgRayleigh.txt", "a")

##fxAvg1 = open(directory+"/FxAvgMie.txt", "a")

fxAvg1 = open(directory+"/FxAvgGO.txt", "a")
